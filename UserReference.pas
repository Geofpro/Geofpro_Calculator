...
type
  ...
  private
    ...
    function Сheckingvalue2 :boolean; //проверка значений таблицы
  public
    { Public declarations }
  end;
...
begin
   ...
   ShowMessage('В столбце Значение не допускается наличие пустых ячеек, допустимы цифры формата 108,6');
  end;
...
function TFrUserReference.Сheckingvalue2: boolean;
   var row, i : Integer;
 n : String;
begin
