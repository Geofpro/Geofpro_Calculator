...
procedure TFrReportsAllDate.DiagramWeight;
  // строим диаграмму с переменным количесвом секторов, данные из основной таблицы расчётов главной формы
  var
...
begin
  ...
  // имя пользователя, скажина и т.д персонализация пользователя
