...
begin
   // проверям, заполнены ли столбцы таблицы StringGrid1 для построения диаграммы
...
procedure TFrDiagramMain.Image1MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
 Label1.Caption:='Диаграмма влияния дополнительных факторов на вес бурильной колонны';
end;
...
procedure TFrDiagramMain.Image2MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
 Label1.Caption:='Диаграмма распределения веса бурильной колонны, кН';
end;
