...
type
  ...
  procedure StartCalculation; // очерЄдность расчЄта, запускаем расчЄт
  procedure StartDiagram;  // строим диаграмму
  procedure CalcProcent; // расчитываем процент дл€ каждой составл€ющей формулы веса
  end;
...
begin
 ...
 SGDiagramData.Cells[1,5]:='—оставл€юща€ от коэффициента kfr, кЌ';
...
begin
 ...
 FillTable;   // заполн€ем таблицу значений
 StartDiagram;  // строим диаграмму
 CalcProcent;  // расчитываем процент дл€ каждой составл€ющей формулы веса
end;
